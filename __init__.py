...
from .scrapers.kimeta import KimetaScraper
...
def scrape_jobs(
    ...
    **kwargs,
    ...
    def scrape_site(site: Site) -> Tuple[str, JobResponse]:
        ...
        site_name = "Stepstone" if cap_name == "Stepstone" else cap_name
    ...
    for site, job_response in site_to_jobs_dict.items():
        for job in job_response.jobs:
            ...
            if compensation_obj and isinstance(compensation_obj, dict):
                ...
                job_data["currency"] = compensation_obj.get("currency", "EURO")
                ...
                if country_enum == Country.DEUTSCHLAND:
                    (
                        job_data["interval"],
                        job_data["min_amount"],
                        job_data["max_amount"],
